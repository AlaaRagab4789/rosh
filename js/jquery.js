...
$('.reservation').css({marginTop: $('.navbar').height()})
 ...
 $('.header').innerHeight(testH-(navH+Footer));
$('.announce-head,.header1,.search-head,.search2-head,.contact,.head-login').css({marginTop: $('.navbar').innerHeight()});
$('.section-two,.header,.products1-head,.products1-read,.products2-read,.products3-read,.products4-read,.products2-head,.products3-head,.products4-head,.products5-head,.products6-head,.description,.section2222,.contact-head').css({marginTop: $('.navbar').innerHeight()});
